...
HD_PWD='/mnt/hgfs/shared_folder/LAB4_2/lab-exmem_fir/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_project_wrapper.tcl
