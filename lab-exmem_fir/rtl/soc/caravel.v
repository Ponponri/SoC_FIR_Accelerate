...
/*                                                          	*/
/*--------------------------------------------------------------*/
`include "/mnt/hgfs/shared_folder/LAB4_2/lab-exmem_fir/rtl/header/defines.v"
`include "/mnt/hgfs/shared_folder/LAB4_2/lab-exmem_fir/rtl/header/user_defines.v"
`default_nettype wire
module caravel (
...
// FPGA:  remove vdd,vss,vcc
     ...
     *--------------------------------------------------------------------
     */
    // new added wires for synthesis
//    wire gpio_inout; 
//    assign gpio = gpio_inout;
